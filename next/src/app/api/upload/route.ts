...
import { r2Client, R2_CONFIG, isR2Configured, generatePublicUrl } from '@/lib/r2';
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: isR2Configured() ? 'File uploaded to R2 successfully' : 'File processed successfully (R2 not configured)',
      fileInfo: {
